...
if __name__ == "__main__":
    ...
    account_deposit_amt.set_deposit_amt("$300.75")
    account_bank_name.set_bank_name("Bank of America")
    account_account_id.set_account_id("23564789")
    account_routing_number.set_routing_number("45172086")
    print("Depositing: " , account_deposit_amt.get_deposit_amt(" "), "in ", account_bank_name.get_account_bank_name(" "),  account_account_id.get_account_id(" "), "using ", account_routing_number.get_account_routing_number(" "))
